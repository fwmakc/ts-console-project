...
> Если указать аргументы, то будет выполнена автоматическая ускоренная установка без дополнительных вопросов.

Первым аргументом можно указать название проекта.

Вторым аргументом можно задать папку, в которую проект будет установлен.

> Если второй аргумент пропущен, то проект установится в папку с названием проекта.
